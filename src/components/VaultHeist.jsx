...
// 12 vaults: 6 multiplier values + 6 traps
// Player picks one at a time. Values add to total. Trap = stop, collect.
// RTP: ~95% with 10x bet cost
const VALUES = [2, 3, 5, 8, 15, 25];
const TRAP_COUNT = 6;
...
function generateVaults() {
  const vaults = [
    ...
    ...Array(TRAP_COUNT).fill({ type: 'trap', amount: 0 }),
  ];
  // Shuffle
    ...
    <div className="vh-overlay">
      <div className="vh-content">
        ...
        <p className="vh-subtitle">
          Pick vaults to add multipliers. Avoid the {TRAP_COUNT} traps!
        </p>
